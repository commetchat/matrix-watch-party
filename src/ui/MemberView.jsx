...
export default (props) => {
    ...
    return (
        <div class="py-1">
            <div class={`w-[56px] h-[56px] rounded-2xl bg-cover ${isSelf() ? " outline-4 outline-(--md-sys-color-primary) outline-solid " : ""} `} style={avatar() == null ? {
                ...
                <Show when={state() != null}>
                    <div class={`p-1 py-5 text-center relative ${state().progress > 3600 ? "text-[10px]" : "text-xs"}`}>
                        <div class="absolute -right-1 -bottom-5 bg-(--md-sys-color-secondary-container) p-0.5 rounded text-(--md-sys-color-on-secondary-container)">
